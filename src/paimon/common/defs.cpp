...
const char Options::FILE_INDEX_BITMAP_COLUMNS[] = "file-index.bitmap.columns";
const char Options::FILE_INDEX_BSI_COLUMNS[] = "file-index.bsi.columns";
const char Options::FILE_INDEX_BLOOM_FILTER_COLUMNS[] = "file-index.bloom-filter.columns";
